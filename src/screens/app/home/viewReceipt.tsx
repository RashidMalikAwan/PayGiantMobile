...
const ViewReceipt = ({ navigation, route }: any) => {
  ...
  return (
    ...
    >
      ...
      />
      <ScrollView showsVerticalScrollIndicator={false} style={[Gutters.smallMargin]}>
        <View
          style={[
            Layout.row,
        ...
        >
          <View style={[Gutters.tinyMargin]}>
            ...
            >
              ...
              >
                ₵ {Number(details?.transferAmount) + (Number(details.transferAmount)*0.01)}
              </Text>
            </View>
          </View>
        </View>
